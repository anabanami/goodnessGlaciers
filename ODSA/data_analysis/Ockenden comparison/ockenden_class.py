...
Writes ockenden_window_class.csv into the run tree (ROOT), which defaults to
OUTPUT_BASE_PATH. Reads only.
"""
import glob, os, sys
...
METRICS = str(ROOT_DIR / 'all_data/Ockenden/Data_Science_Zenodo/Data_Science_Zenodo/Metrics')
