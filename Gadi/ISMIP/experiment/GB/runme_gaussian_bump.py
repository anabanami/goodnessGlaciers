...
plt.title("Full mesh") 
plt.savefig(f"gaussian_bump_mesh.png")
# plt.show()
...
plt.savefig(f"gaussian_bump_mesh_boundaries.png")
# plt.show()
...
plt.savefig("gaussian_bump_grounded_ice_elements.png")
# plt.show()
...
plt.savefig("gaussian_bump_thickness_geometry_2D.png")
# plt.show()
...
plt.savefig("gaussian_bump_geometry_3D.png")
# plt.show()

# 2D plot
iplt.plot_model_field(md, md.geometry.base, layer=1, show_cbar = True)
plt.title("Base geometry") 
plt.savefig("gaussian_bump_base_geometry_2D.png")
# plt.show()
