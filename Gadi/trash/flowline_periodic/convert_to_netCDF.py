# Based on flowline_periodic.py - Flowband model with cosine undulations, flat in and out flow bedrock and periodic BCs
# Ana Fabela Hinojosa
import sys
import numpy as np
...
if __name__== '__main__':
    ...
    md = loadresultsfromdisk(md, 'flowline_periodic.outbin') 
