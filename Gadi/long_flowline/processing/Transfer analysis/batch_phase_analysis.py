...
# point to the real bedrock_profiles folder
BEDROCK_DIR = os.path.join(parent_dir, 'bedrock_profiles')
...
def load_time_step_data(dataset, time_step, config):
    ...
    # Get time from the correct netCDF structure
...
if __name__ == '__main__':
    ...
    for scenario in SCENARIOS:
        scen_path = os.path.join(script_dir, scenario)
