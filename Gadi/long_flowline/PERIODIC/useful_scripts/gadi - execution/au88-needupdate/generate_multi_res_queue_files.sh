...
TIMESTEP=1/12 # years (base timestep = 1/12, actual timestep = base/resolution_factor)
...
mpiexec -np 12 \$ISSM_DIR/bin/issm.exe TransientSolution ${RES_DIR} ${MODEL_NAME} ${EXEC_DIR}
EOF
