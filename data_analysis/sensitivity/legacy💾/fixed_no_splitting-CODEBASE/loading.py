...
# Output configuration. Results land in TESTING_LANDSCAPE_SPLITTING/ (RESULTS_ROOT), where the
# v23 test scripts expect them — never in ODSA/, so this snapshot cannot overwrite the baseline.
